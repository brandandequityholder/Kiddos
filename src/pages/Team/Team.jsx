...
import founderFour from './04.mp4';
import founderFive from './05.mp4';
...
import { getTeamPageData } from '../../lib/queries';
import renderPreTitle from '../../utils/renderPreTitle';
import removeBr from '../../utils/removeBar';
function chunkByThree(arr) {
	const chunks = [];
		...
		<div className='bg-white overflow-hidden  space-y-[20px]   lg:pl-[48px]  pt-[48px] px-[30px] py-[24px] w-full lg:w-[359px] rounded-[30px] h-fit  lg:h-[730px] '>
			...
			<div className='space-y-[5px]'>
				...
				<div className=" w-full justify-start text-[#004aad] text-[15px] font-[500] font-['Montserrat'] leading-[23.29px]">
					{description && renderPreTitle(description)}
				</div>
			</div>
		</div>
	);
...
function Team() {
					...
					<div className='max-w-[1243.406px]  w-full relative lg:pl-[40px] lg:px-0  px-[40px] pb-[100px] lg:pb-[300px] pt-[50px] lg:pt-[137px] mx-auto'>
						<p className='max-w-[671px] lg:block hidden  justify-start'>
							<span class="text-[#004aad] text-[75px] leading-[100%] font-bold font-['League_Spartan']">
								We Care for, <br /> Build Confidence in, <br />& Yield
								Creativity from, Your Kids.
							</span>
					...
					<div className='max-w-[1243.406px] lg:pl-[32px] px-[40px]  lg:space-x-[80px]  justify-start flex lg:flex-row flex-col w-full mx-auto'>
						...
						<div className='  space-y-[20px] lg:space-y-[20px]'>
							...
							<div className="w-full max-w-[320px] lg:max-w-[650px]  justify-start text-[#004AAD] text-[14px] lg:text-[20px] font-[500] lg:font-[500] font-['Montserrat'] leading-[27.8px] lg:leading-[33px] ">
								...
								attended Morris Brandon, Sutton, and North Atlanta before
								earning her BBA from Georgia State University. Lara has
								experienced camp life from all angles: she was a camper and
								after-school participant herself, and later became a counselor,
								teacher, mentor, and director. Creating Kiddos has been her way
								to give back to the community that raised her, and she leads our
								program with boundless energy, genuine care, and an eye for
								detail.
							</div>
						</div>
					</div>
						...
						<div className='space-y-[44px] lg:space-y-[76px] lg:max-w-[1243.406px] w-full mx-auto   '>
							<div className='flex lg:flex-row justify-center items-center flex-col relative space-y-[44px]  lg:space-x-[32px]  lg:space-y-0 '>
								<FounderCard
									...
									description={
										<>
											...
											since 2016 and truly embodies our fun-loving Kiddos
											culture. She makes sure all of our after-school programs
											and summer camps stay top-notch by overseeing all three
											sites. She’s often the friendly voice on the main phone,
											taking care of our families, leading our team, and making
											sure every kiddo is having a great time!
										</>
									}
									surname='PROGRAMS DIRECTOR'
								/>
								<FounderCard
									...
									description={
										<>
											Our kiddos lovingly call her{' '}
											<strong>“BK Thunder.”</strong> Ms. Becca has been part of
											the Kiddos family since 2016. She started as a teacher at
											our E. Rivers location and worked her way up to lead
											teacher and assistant director. In 2022, she proudly
											stepped into the role of Director at E. Rivers. Ms.
											Becca’s creativity, attention to detail, and genuine love
											for every kiddo are exactly why your child will beg to
								...
								<FounderCard
									...
									description={
										<>
											Our kiddos affectionately call her{' '}
											<strong>“Pepto.”</strong> Delaney has been with Kiddos
											since we first opened in 2011, when she started as a
											counselor-in-training and grew into a counselor, teacher,
											and assistant director. Now she shines as the Director at
											ACA (Atlanta Classical Academy). Delaney’s genuine love
											for every kiddo, her dedication to her job, and her
											willingness to jump in wherever needed make her a rockstar
											to her teammates and to the kiddos alike!
										</>
									}
							...
							<div className='flex lg:flex-row flex-col space-y-[44px] lg:space-y-0  relative justify-center lg:space-x-[32px] items-stretch'>
								<FounderCard
									...
									description={
										<>
											Our kiddos fondly call her <strong>“Sassy.”</strong>{' '}
											Sophie joined Kiddos in 2014 as a high school helper and
											grew into roles as a teacher, lead teacher, office
											coordinator, and interim director. Today, she proudly
											serves as the Director at Garden Hills. Sophie truly
											embodies the Kiddos values and knows how to lead a highly
											motivated, happy team. She has a special way of keeping
											everyone organized and thoughtful while making sure
											everything stays fun!
										</>
									}
	...
	const { heroSection, founderSection, founders, FoundersSection } = data;
	return (
		<div className='overflow-x-hidden relative'>
			<section className='w-full relative  bg-[#F8FBFF] lg:bg-[#F8FBFF] mt-[78px] pt-[78px]'>
				<div className=' lg:block hidden'>
				...
				<div className='max-w-[1243.406px]  w-full relative lg:pl-[40px] lg:px-0  px-[40px] pb-[100px] lg:pb-[300px] pt-[50px] lg:pt-[137px] mx-auto'>
					<p className='max-w-[671px] lg:block hidden  justify-start'>
						<span class="text-[#004aad] text-[75px] leading-[100%] font-bold font-['League_Spartan']">
							{renderPreTitle(heroSection.title)}
						</span>
						<span class="text-[#74ca31] text-[75px] leading-[100%] font-bold font-['League_Spartan']">
							<br />
							{renderPreTitle(heroSection.subtitle)}
							<br />
						</span>
					</p>
			...
			<section className='w-full h-fit bg-[#F8FBFF] lg:bg-[#F8FBFF]'>
				<div className='max-w-[1243.406px] lg:pl-[32px] px-[40px]  lg:space-x-[80px]  justify-start flex lg:flex-row flex-col w-full mx-auto'>
					<p className='w-full max-w-[815.77px] pb-[40px] lg:hidden  justify-center'>
						<span class='text-[#004aad] text-[39.333px] font-normal MadeGentle leading-[36.973px]'>
							{renderPreTitle(founderSection.title)}
							<br />
						</span>
						<span class='text-[#86d24a] text-[39.33px] font-normal MadeGentle leading-[36.97px]'>
							{founderSection.name}
			...
			<section className='bg-[#F8FBFF] lg:bg-[#F8FBFF] '>
				<div className='max-w-[1243.406px] space-y-[100px]  px-[40px] lg:pl-[115px] pb-[100px] pt-[100px] lg:pt-[240px] w-full mx-auto'>
					<div className='space-y-[30px]'>
						<h1 className='lg:block hidden w-full max-w-[1037px]  justify-center'>
							<span class='text-[#004aad] text-[63px] font-normal MadeGentle leading-[58.72px]'>
								{renderPreTitle(FoundersSection.title)}
							</span>
						</h1>
						<h1 className='max-w-[364px] w-full lg:hidden  justify-center'>
							<span class='text-[#004aad] text-[39.33px] font-normal MadeGentle leading-[36.97px]'>
						...
						<div className="max-w-[1015px] lg:block hidden w-full justify-center text-[#004aad] text-xl font-medium font-['Montserrat'] leading-9">
							{renderPreTitle(FoundersSection.subtitle)}
						</div>
				...
				<div className='relative pb-[200px]  px-[40px] lg:pl-[32px]  w-full mx-auto'>
					...
					/>
					<div className='space-y-[44px] lg:space-y-[76px] lg:max-w-[1243.406px] w-full mx-auto   '>
						{chunkByThree(founders).map((row, rowIndex) => (
							<div className='flex lg:flex-row justify-center items-center flex-col relative space-y-[44px]  lg:space-x-[32px]  lg:space-y-0 '>
								{row.map((founder, i) => (
									<FounderCard
										key={i}
										videoSrc={founder.videoUrl}
										name={founder.name}
										surname={founder.role}
										description={founder.description}
										blob={founder.blobUrl}
										blobPos={founder.blobPosition}
									/>
								))}
							</div>
						))}
				...
				<div>
					<img
						src={lastCurve}
						alt=''
						className='w-full -bottom-0 bg-[#CEDEF1]'
					/>
				</div>
			</section>
		</div>
