...
import { getSchedulePageData } from '../../lib/queries';
...
function Schedule() {
	...
	useEffect(() => {
		async function fetchData() {
			const pageData = await getSchedulePageData();
			setData(pageData);
		}
		fetchData();
	}, []);
				...
				<section className=' relative   bg-[#F8FBFF]  '>
					...
					<div className='max-w-[306px] pt-[50px] lg:mx-auto lg:max-w-[1243.406px] ml-[40px] pr-0 mr-0  lg:pl-[132px] -mt-[1px] space-y-[50px] w-full  '>
						...
						<p className=" pb-[20px] max-w-[300px] text-[#004AAD] lg:max-w-[971px] w-full min-h-[84px] justify-start text-[14px] lg:text-xl font-[400] lg:font-medium font-['Montserrat'] leading-[33.10px]">
							...
							staying active, engaged, and having an absolute blast! We’ve
							crafted a fun-filled space where every moment is packed with
							chances to grow. Let's make unforgettable memories together!
						</p>
					</div>
				...
				<section className='min-h-[669px]  relative bg-[#0A3E82] w-full'>
					<div className='lg:max-w-[1243.406px] lg:flex-row flex-col flex ml-[40px] lg:pl-[132px] lg:space-x-[60px] w-full py-[50px] lg:py-[156px] mx-auto'>
						...
						<p className="max-w-[292px] lg:max-w-[545px] w-full min-h-[132px] justify-start text-white  text-[14px] lg:text-[20px] font-medium font-['Montserrat'] leading-[33.10px]">
							With Campers Choice, every camper designs their own day, no two
							ever look the same! <br />
							<br /> Kids explore passions, try something new, and take
							ownership of their fun through art, athletics, science, dance, and
							more all within a safe, supportive, and wildly creative
							environment. <br />
							<br />
							Here are some of the over <strong>720 activities</strong> your
							child gets to choose from each day!
						</p>
					</div>
					<img
						src={thirdCurve}
					...
					<div className='bg-[#F8EA2B] z-10 relative'>
						<div className='max-w-[1243.406px]  pt-[130px] space-y-[50px] lg:space-y-[70px] items-center flex-col px-[40px] justify-center items-center w-full mx-auto'>
							...
							<div className="max-w-[1029px] w-full mx-auto lg:h-[95px] text-center justify-start text-[#004aad] text-[15px]  lg:text-[20px] font-medium font-['Montserrat'] leading-8">
								...
								periods and they choose their very own QUEST! Each camper
								selects a long-term project or skill to dive deep into for the
								week—think Parkour, T-shirt Printing, Street Art, Sports,
								Sculpture, Cooking, and more! With three dedicated periods for
								their QUEST, they’ll explore their passions while also still
								enjoying three periods of dynamic activities mixed with all
								grades. Campers will pick their QUEST at registration!
							</div>
						</div>
					</div>
	...
	return (
		<div className='  relative  w-screen   -mt-[5px]'>
			<FirstSecSchedule {...firstSection}></FirstSecSchedule>
			<section className=' relative   bg-[#F8FBFF]  '>
				<div className='absolute lg:block hidden z-20 right-0 -bottom-[70px]'>
					<svg
						width='739'
				...
				<div className='max-w-[306px] pt-[50px] lg:mx-auto lg:max-w-[1243.406px] ml-[40px] pr-0 mr-0  lg:pl-[132px] -mt-[1px] space-y-[50px] w-full  '>
					<p className='max-w-[306px]  lg:max-w-[1037px] w-full justify-center'>
						<span class='text-[#004aad] lg:block hidden text-[50.732px]  lg:text-[63px] font-normal MadeGentle leading-[47.283px] lg:leading-[58.72px]'>
							{heroSection.titleBlue ? (
								removeBr(heroSection.titleBlue)
							) : (
								<>
									What Does <br className='lg:hidden' /> Kiddos Have{' '}
									<br className='lg:hidden' /> to Offer?
								</>
							)}

							<br />
						</span>
						<span class='text-[#004aad] lg:hidden  text-[50.732px]  lg:text-[63px] font-normal MadeGentle leading-[47.283px] lg:leading-[58.72px]'>
							{heroSection.titleBlue ? (
								renderPreTitle(heroSection.titleBlue)
							) : (
								<>
									What Does <br className='lg:hidden' /> Kiddos Have{' '}
									<br className='lg:hidden' /> to Offer?
						...
						<span class='text-[#75CB31] text-[50.732px]  lg:text-[63px] font-normal MadeGentle leading-[47.283px] lg:leading-[58.72px]'>
							{heroSection.titleGreen || 'A Whole Bunch!'}
						</span>
					</p>
					<p className=" pb-[20px] max-w-[300px] text-[#004AAD] lg:max-w-[971px] w-full min-h-[84px] justify-start text-[14px] lg:text-xl font-[400] lg:font-medium font-['Montserrat'] leading-[33.10px]">
						{heroSection.description || (
							<>
								From start to finish, the camp day is all about your unique
								camper staying active, engaged, and having an absolute blast!
								We’ve crafted a fun-filled space where every moment is packed
								with chances to grow. Let's make unforgettable memories
								together!
							</>
						)}
					</p>
			...
			<section className='min-h-[669px]  relative bg-[#0A3E82] w-full'>
				<div className='lg:max-w-[1243.406px] lg:flex-row flex-col flex ml-[40px] lg:pl-[132px] lg:space-x-[60px] w-full py-[50px] lg:py-[156px] mx-auto'>
					<h1 className='w-[379px] pt-[46px] min-h-[225px] justify-center'>
						<span class='text-white text-[65.261px] lg:text-[83px] font-normal MadeGentle leading-[77px]'>
							{campersChoice.titleWhite || 'Campers'}
							<br />
						</span>
						<span class='text-[#f8ea2b] text-[65.261px] lg:text-[83px]  font-normal MadeGentle leading-[77px]'>
							{campersChoice.titleYellow || 'Choice'}
						</span>
					</h1>
					<p className="max-w-[292px] lg:max-w-[545px] w-full min-h-[132px] justify-start text-white  text-[14px] lg:text-[20px] font-medium font-['Montserrat'] leading-[33.10px]">
						{campersChoice.description ? (
							renderPreTitle(campersChoice.description)
						) : (
							<>
								With Campers Choice, every camper designs their own day, no two
								ever look the same! <br />
								<br /> Kids explore passions, try something new, and take
								ownership of their fun through art, athletics, science, dance,
								and more all within a safe, supportive, and wildly creative
								environment. <br />
								<br />
								Here are some of the over <strong>720 activities</strong> your
								child gets to choose from each day!
			...
			<section className='  relative z-10    w-full'>
				...
				<div className='bg-[#F8EA2B] z-10 relative'>
					<div className='max-w-[1243.406px]  pt-[130px] space-y-[50px] lg:space-y-[70px] items-center flex-col px-[40px] justify-center items-center w-full mx-auto'>
						...
						<p className='text-center justify-center text-[#004aad]  text-[31.502px] lg:text-[65px] font-normal MadeGentle lg:leading-[38.91px]'>
							{questsSection.titleMainOne || 'QUESTS'}
							<span className='font-["Montserrat"]'>
								{questsSection.titleMainTwo || 'FOR THE BIG KIDS!'}
							</span>
						</p>
						<div className="max-w-[1029px] w-full mx-auto lg:h-[95px] text-center justify-start text-[#004aad] text-[15px]  lg:text-[20px] font-medium font-['Montserrat'] leading-8">
							{questsSection.description || (
								<>
									Our rising 5th and 6th grade campers swap out some activity
									periods and they choose their very own QUEST! Each camper
									selects a long-term project or skill to dive deep into for the
			...
			<DailyProg {...dailyProgram}></DailyProg>
			<div className='relative  -mt-[170px] lg:-mt-[250px]'>
				<AnythingElse></AnythingElse>
			</div>
		</div>
