...
import stepOne from './Assets/one.svg'
import stepTwo from './Assets/Two.svg';

import stepThree from './Assets/Three.svg';

import stepFour from './Assets/Four.svg';
import stepFive from './Assets/Five.svg';
import { Link } from 'react-router-dom';
import AnythingElse from '../../components/AnythingElse';
import { Four, One, Three, Two } from './Assets/icons';
import { useState, useEffect } from 'react';
import { getPricingPageData } from '../../lib/queries';
...
function Pricing() {
	...
	useEffect(() => {
		getPricingPageData().then(setData);
	}, []);
	useEffect(() => {
		console.log(data);
	}, [data]);
					...
					<div className='max-w-[1243.406px]   w-full relative lg:px-0 px-[40px] pb-[50px]  lg:pb-[240px] pt-[50px] lg:pt-[160px] mx-auto'>
						<div className='pl-[70px] lg:block hidden space-y-[20px] '>
							...
							<p className="max-w-[377px] w-full  justify-center text-[#004aad] text-[20px] font-normal font-['Montserrat'] leading-[28.3px]">
								Enrolling in Kiddos Day Camp is easy and secure. We use an
								online registration system to streamline your sign-up process
								and ensure we have all the information we need to take the best
								care of your child. Follow the steps below to get started:
							</p>
						</div>
						...
						<div className=' lg:max-w-[819.69px] min-h-[100px] mx-auto  border-[0.80px] border-[#75CB31]'>
							...
							<div className='border-b-[0.80px] items-center flex px-[20px] lg:px-[40.86px] py-[20px]  min-h-[84.851px] w-full border-[#75CB31]'>
								<div className=" justify-center text-[#004aad] text-[17px] font-medium font-['Montserrat'] leading-[30.42px]">
									To secure your spot, a $75 deposit per week per child is due
									at registration. If you opt for After Camp, the fee for that
									($50/week) is added to your deposit, except if you qualify for
									a 4-week+ discount on after camp (then you pay only $15/week).
									You can pay by credit/debit card through the secure system.
									This deposit counts toward your camp tuition. The remaining
									balance will be charged to card on file on May 1st, 2026
									<br />
								</div>
							</div>
									...
									<div className=' h-[250px]  lg:h-[212.93px] lg:text-start text-center  space-y-[10px] relative flex flex-col justify-center  lg:pl-[34.42px] w-full'>
										...
										<p className=" text-[#004aad]  text-[14px] lg:text-[20px] font-bold font-['League_Spartan'] leading-[22px] lg:leading-[34.42px] justify-center">
											...
											<span className="text-[#004aad] text-[14px] lg:text-[20.012px] font-normal font-['League_Spartan'] leading-[22px] lg:leading-[34.42px]">
												...
												Kiddos water bottle. Hydration and snacks? You’re all
												set for camp fun! <br />
											</span>
										</p>
										<Link
									...
									<div className='h-[250px] lg:h-[239.34px] pt-[160px] lg:pt-[15px]  lg:text-start text-center   relative flex flex-col justify-center  lg:pl-[34.42px] w-full'>
										...
										<p className=' justify-center'>
											...
											<span class="text-[#004aad] text-[14px] lg:text-[20px] font-normal font-['League_Spartan'] leading-[22px] lg:leading-[34.42px]">
												Discounted rates to make it easier for siblings to
												attend together. <br />
												Second child
											</span>
							...
							<div className='border-b-[0.80px] items-center flex px-[30.86px] py-[20px]  min-h-[84.851px] w-full border-[#75CB31]'>
								<div className=" justify-center text-[#004aad] text-[17px] font-medium font-['Montserrat'] leading-[31.219px]">
									We believe every child should have the chance to go to camp.
									We offer a limited number of scholarship spots each summer for
									...
									<br /> The deadline for scholarship applications is February
									15. Email{' '}
									<Link
							...
							<div className=' items-center flex px-[30.86px] py-[20px]  min-h-[84.851px] w-full border-[#75CB31]'>
								<div className=" justify-center text-[#004aad] text-[17px] font-medium font-['Montserrat'] leading-[30.42px]">
									...
									info@KiddosAtlanta.com by Friday May 22, and we’ll only keep
									the $75 per week deposit. No last-minute cancellations,
									please—summer school is not an exception! If you bail without
									that notice or forget to show up, the full balance will still
									be charged. And remember, until that balance is settled,
									campers can’t return to camp or any Kiddos program. So, please
									plan ahead!
								</div>
							</div>
						</div>
					...
					<div className='pl-[70px] lg:block hidden space-y-[20px] '>
						<p className="w-full max-w-[524.92px]  justify-center text-[#004aad] text-[67.80px] leading-[100%] font-bold font-['League_Spartan']">
							{heroSection.headline ? (
								renderPreTitle(heroSection.headline)
							) : (
								<>
									Camp Rate <br /> & Registration Information
								</>
						...
						<p className="max-w-[377px] w-full  justify-center text-[#004aad] text-[20px] font-normal font-['Montserrat'] leading-[28.3px]">
							{heroSection.subHeadline ? (
								renderPreTitle(heroSection.subHeadline)
							) : (
								<>
									Enrolling in Kiddos Day Camp is easy and secure. We use an
									online registration system to streamline your sign-up process
									and ensure we have all the information we need to take the
									best care of your child. Follow the steps below to get
									started:
								</>
							)}
						</p>
				...
				<div className='max-w-[1243.406px] space-y-[50px]  w-full relative pt-[50px] lg:pt-[100px] lg:px-[126px] px-[40px] pb-[50px]  mx-auto'>
					...
					<div className=' lg:max-w-[819.69px] min-h-[100px] mx-auto  border-[0.80px] border-[#75CB31]'>
						<div className='border-b-[0.80px] items-start lg:items-center lg:space-y-0 space-y-[10px] justify-between lg:flex-row flex flex-col pl-[15px] lg:py-0 py-[20px] lg:px-[40.86px]  min-h-[84.851px] w-full border-[#75CB31]'>
							...
							<div className='justify-center text-[#75CB31] text-[24px] lg:text-[31.64px] font-normal MadeGentle leading-[23px] lg:leading-[34.42px]'>
								{ratesSection.baseRate || <>$275.00 / Per Week</>}
							</div>
						</div>
						<div className='border-b-[0.80px] items-start lg:items-center lg:space-y-0 space-y-[10px] justify-between lg:flex-row flex flex-col pl-[15px] lg:py-0 py-[20px] lg:px-[40.86px]  min-h-[84.851px] w-full border-[#75CB31]'>
							<div className=' justify-center  w-full lg:w-[391px]  text-[#004aad] text-[24px] lg:text-[31.64px] font-normal MadeGentle leading-[34.42px]'>
							...
							<div className='justify-center text-[#75CB31] text-[24px] lg:text-[31.64px] font-normal MadeGentle leading-[23px] lg:leading-[34.42px]'>
								{ratesSection.deposit || <> $75/ Per Camper</>}
							</div>
						</div>
						<div className='border-b-[0.80px] items-start lg:items-center lg:space-y-0 space-y-[10px] justify-between lg:flex-row flex flex-col pl-[15px] lg:py-0 py-[20px] lg:px-[40.86px]  min-h-[84.851px] w-full border-[#75CB31]'>
							<div className=' justify-center   text-[#004aad] text-[24px] lg:text-[31.64px] font-normal MadeGentle leading-[28px] lg:leading-[34.42px]'>
						...
						<div className='border-b-[0.80px] items-center flex px-[20px] lg:px-[40.86px] py-[20px]  min-h-[84.851px] w-full border-[#75CB31]'>
							<div className=" justify-center text-[#004aad] text-[17px] font-medium font-['Montserrat'] leading-[30.42px]">
								{ratesSection.details || (
									<>
										To secure your spot, a $75 deposit per week per child is due
										at registration. If you opt for After Camp, the fee for that
										($50/week) is added to your deposit, except if you qualify
										for a 4-week+ discount on after camp (then you pay only
										$15/week). You can pay by credit/debit card through the
										secure system. This deposit counts toward your camp tuition.
										The remaining balance will be charged to card on file on May
										1st, 2026
									</>
								)}
								<br />
						...
						<div className='border-b-[0.80px]  flex  items-center lg:p-0 p-[15px]   min-h-[84.851px] w-full border-[#75CB31]'>
							...
							<div className='w-full lg:w-[553.93px] h-full pb-[18px] lg:border-l-[0.80px] border-[#75CB31]'>
								<div className=' h-[250px]  lg:h-[212.93px] lg:text-start text-center  space-y-[10px] relative flex flex-col justify-center  lg:pl-[34.42px] w-full'>
									...
									<p className=" text-[#004aad]  text-[14px] lg:text-[20px] font-bold font-['League_Spartan'] leading-[22px] lg:leading-[34.42px] justify-center">
										<span className='uppercase'>
											{discountsSection.first.heading || (
												<>Register Early-by January 15</>
											)}
										</span>{' '}
										<br />
										<span className="text-[#004aad] text-[14px] lg:text-[20.012px] font-normal font-['League_Spartan'] leading-[22px] lg:leading-[34.42px]">
											{discountsSection.first.subHeadiing || (
												<>
													Register early and get a Kiddos mesh back pack and a
													fun Kiddos water bottle. Hydration and snacks? You’re
													all set for camp fun!
												</>
											)}{' '}
											<br />
										</span>
								...
								<div className='h-[250px] pt-[100px] lg:pt-0 lg:h-[212.93px]  lg:text-start text-center relative flex flex-col justify-center  lg:pl-[34.42px] w-full'>
									...
									<p className=' text-[#004aad]  text-[14px] lg:text-xl font-bold font-["League_Spartan"] leading-[22px] lg:leading-[34.42px] justify-center'>
										{discountsSection.second.heading ? (
											renderPreTitle(discountsSection.second.heading)
										) : (
											<>
												ADD BONUS HOURS: <br />{' '}
											</>
									...
									<p className=' text-[#004aad]  text-[14px] lg:text-xl font-normal font-["League_Spartan"] leading-[22px] lg:leading-[34.42px] justify-center'>
										{discountsSection.second.subHeadiing ? (
											renderPreTitle(discountsSection.second.subHeadiing)
										) : (
											<>
												<span className="text-[#004aad] text-[14px] lg:text-xl font-normal font-['League_Spartan'] leading-[26px] lg:leading-[34.42px]">
													Extended After Camp (2:30–6:00){' '}
								...
								<div className='h-[250px] lg:h-[239.34px] pt-[160px] lg:pt-[15px]  lg:text-start text-center   relative flex flex-col justify-center  lg:pl-[34.42px] w-full'>
									...
									<p className=' justify-center'>
										<span class="text-[#004aad] text-[14px] lg:text-[20px] font-bold font-['League_Spartan'] leading-[22px] lg:leading-[34.42px]">
											{discountsSection.third.heading ? (
												renderPreTitle(discountsSection.third.heading)
											) : (
												<>SIBLING DISCOUNT: </>
											)}
										</span>{' '}
									...
									<p class="text-[#004aad] text-[14px] lg:text-[20px] font-normal font-['League_Spartan'] leading-[22px] lg:leading-[34.42px]">
										{discountsSection.third.subHeadiing ? (
											renderPreTitle(discountsSection.third.subHeadiing)
										) : (
											<>
												<span class="text-[#004aad] text-[14px] lg:text-[20px] font-normal font-['League_Spartan'] leading-[22px] lg:leading-[34.42px]">
													Discounted rates to make it easier for siblings to
								...
								<div className='h-[250px] lg:h-[212.13px] mb-[180px]  lg:mb-0 pt-[220px] lg:pt-[25px] lg:text-start text-center  relative flex flex-col justify-center  lg:pl-[34.42px] w-full'>
									...
									<p className=' justify-center'>
										<span class="text-[#004aad] text-[14px] lg:text-[20px] font-bold font-['League_Spartan'] leading-[34.42px]">
											{discountsSection.paySchedule.heading ? (
												renderPreTitle(discountsSection.paySchedule.heading)
											) : (
												<>MULTI-WEEK DISCOUNT:</>
											)}
										</span>
									</p>
									<p class="text-[#004aad] text-[14px] lg:text-[20px] font-normal font-['League_Spartan'] leading-[34.42px]">
										{discountsSection.paySchedule.subHeadiing ? (
											renderPreTitle(discountsSection.paySchedule.subHeadiing)
										) : (
											<>
												<span class="text-[#004aad] text-[14px] lg:text-[20px] font-normal font-['League_Spartan'] leading-[22px] lg:leading-[34.42px]">
													If a camper attends 4 or more weeks: <br />
						...
						<div className='border-b-[0.80px] items-center flex px-[30.86px] py-[20px]  min-h-[84.851px] w-full border-[#75CB31]'>
							<div className=" justify-center text-[#004aad] text-[17px] font-medium font-['Montserrat'] leading-[31.219px]">
								{policiesSection.Scholarshipheading ? (
									renderPreTitle(policiesSection.Scholarshipheading)
								) : (
									<>
										We believe every child should have the chance to go to camp.
										We offer a limited number of scholarship spots each summer
										for families with financial need. These are typically
										partial scholarships (covering a portion of tuition) awarded
										to returning campers and then on a first-come,
										first-considered basis. If you could use assistance, please
										apply for a scholarship or contact us for the simple
										application form. We consider income and any special
										circumstances, and handle all inquiries confidentially. {' '}
										<br />
										<br /> The deadline for scholarship applications is February
										15. Email{' '}
										<Link
										...
										to see if scholarships are still available and to receive
						...
						<div className=' items-center flex px-[30.86px] py-[20px]  min-h-[84.851px] w-full border-[#75CB31]'>
							<div className=" justify-center text-[#004aad] text-[17px] font-medium font-['Montserrat'] leading-[30.42px]">
								{policiesSection.Cancelationheading || (
									<>
										If you need to cancel, just shoot us an email at
										info@KiddosAtlanta.com by Friday May 22, and we’ll only keep
										the $75 per week deposit. No last-minute cancellations,
										please—summer school is not an exception! If you bail
										without that notice or forget to show up, the full balance
										will still be charged. And remember, until that balance is
										settled, campers can’t return to camp or any Kiddos program.
