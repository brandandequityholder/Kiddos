...
import { getKiddosWayPageTextData } from '../../lib/queries';
...
function Values() {
	...
	useEffect(() => {
		...
		getKiddosWayPageTextData().then(setData).catch(console.error);
	}, []);
					...
					<div className='max-w-[1243.406px]   w-full relative lg:px-0 px-[40px] pb-[50px]  lg:pb-[240px] pt-[50px] lg:pt-[150px] mx-auto'>
						<div className='pl-[70px] lg:block hidden space-y-[20px] '>
							...
							<p className="max-w-[382px]  justify-center text-[#004AAD] text-[20px] font-normal font-['Montserrat'] leading-[28.3px]">
								Since 2011, Kiddos Day Camp has been all about engaging,
								educating and empowering our campers! With a team that’s as
								passionate as they come, we create a summer experience where
								kids thrive and make lifelong memories in a fun and safe
								environment. Let the adventures begin!
							</p>
						</div>
				...
				<section className='bg-[#EBF2FB] '>
					<div className='max-w-[1243.406px] pt-[100px]  space-y-[50px]  w-full relative lg:px-[126px] px-[40px] pb-[50px]  mx-auto'>
						...
						<p className="w-full max-w-[953px]  justify-start text-[#004aad] text-base lg:text-lg font-medium font-['Montserrat'] leading-7 lg:leading-9">
							...
							Founded by Atlanta native Lara Cornett in 2011, Kiddos started as
							a humble summer camp with just 25 children, and quickly grew to 70
							campers in just three weeks of its first summer. From that early
							success, Lara knew she was onto something special. Her “aha
							moment” on New Year’s Day 2011 sparked what she called “The Kiddos
							Way” – an approach to childcare that provides a fun place to play,
							where kids get to make choices, feel safe, and build confidence –
							all under the guidance of energetic role models who truly care
							about them.
						</p>
					</div>
					<div className='max-w-[1243.406px]  space-y-[50px]  w-full relative lg:px-[126px] px-[40px] pb-[50px]  mx-auto'>
						...
						<p className="w-full max-w-[953px]  justify-start text-[#004aad] text-base lg:text-lg font-medium font-['Montserrat'] leading-7 lg:leading-9">
							...
							programs at Atlanta elementary schools (E. Rivers, Atlanta
							Classical Academy, Garden Hills) during the school year.
							Additionally, we offer a year round Kiddos Early Learning Center
							for our younger kiddos just next door to Camp. We’ve stayed true
							to our roots even as we’ve grown – keeping “The Kiddos Way” alive
							requires an AMAZING team that feels more like family (“framily,”
							as we say). We are incredibly proud of our team’s dedication,
							which has enabled Kiddos Camps to consistently improve every year.
							Each summer is better than the last, as we learn, adapt, and add
							new fun traditions. 
						</p>
					</div>
					<div className='max-w-[1243.406px]   space-y-[50px]  w-full relative lg:px-[126px] px-[40px] pb-[50px]  mx-auto'>
						...
						<p className="w-full max-w-[953px]  justify-start text-[#004aad] text-base lg:text-lg font-medium font-['Montserrat'] leading-7 lg:leading-9">
							...
							members undergo background checks and rigorous training each
							season. We train our counselors to not only prioritize safety, but
							also to be engaging role models who bring creativity, enthusiasm,
							and empathy to camp. Most of our counselors either work with the
							after school year round or started as campers and went through our
							counselor training program.  Our leadership team works closely
							with the counselors every day to maintain our high standards.
							We’re proud to say that some of our staff literally grew up with
							Kiddos – for example, a former Camper from 2011 is now a Camp
							Director. This continuity means our culture and knowledge are
							strong. When you drop your child off at Kiddos Day Camp, you can
							rest assured they are in capable hands.
						</p>
					</div>
				</section>
				<section className='bg-[#F8FBFF] pb-[50px] lg:pb-[100px]'>
					...
					<div className='max-w-[1243.406px]  space-y-[50px]  w-full relative lg:px-[126px] px-[40px] pb-[50px]  mx-auto'>
						...
						<p className="w-full max-w-[1017px] justify-start text-[#004aad] text-base lg:text-lg font-medium font-['Montserrat'] leading-7 lg:leading-9">
							Kiddos Camps has been recognized in the community for excellence.
							We were honored to be voted “Best Summer Camp in Atlanta” in Red
							Tricycle’s Totally Awesome Awards. We’ve also received accolades
							for our after-school programs (earning a “Best Afterschool
							Program” title in a local Buckhaven poll).
							<br />
							<br />
							These awards mean a lot to us because they come from the families
							we serve – there’s no greater compliment than our parents and
							community saying we’re the best at what we do. Additionally,
							Newsweek’s 2024 national camp rankings highlighted the importance
							of things we pride ourselves on – like diverse activities, great
							staff-to-camper ratios, and strong safety measures. <br />
							<br />
							...
							for us is the smiling faces of campers and the glowing feedback
							from parents who tell us their kids can’t wait to come back each
							day.
						</p>
					</div>
				</section>
	...
	// Destructure data for easier access in the JSX
	const {
		heroSection,
		pinkyPromiseSection,
		storyMissionSection,
		...
		<div>
			<section className='w-full relative z-10 lg:min-h-screen bg-[#F8FBFF]  mt-[78px] pt-[78px]'>
				...
				<div className='max-w-[1243.406px]   w-full relative lg:px-0 px-[40px] pb-[50px]  lg:pb-[240px] pt-[50px] lg:pt-[150px] mx-auto'>
					<div className='pl-[70px] lg:block hidden space-y-[20px] '>
						<p className="w-full max-w-[524.92px]  justify-center text-[#004aad] text-[67.80px] leading-[100%] font-bold font-['League_Spartan']">
							{renderPreTitle(heroSection.mainHeadline)}
						</p>
						<p className="max-w-[382px]  justify-center text-[#004AAD] text-[20px] font-normal font-['Montserrat'] leading-[28.3px]">
							{renderPreTitle(heroSection.description)}
						</p>
					</div>
					<div className="w-[345px] lg:hidden h-[200px] justify-start text-[#004aad] text-[50px] font-bold font-['League_Spartan'] leading-[44.50px]">
						{renderPreTitle(heroSection.mainHeadline)}
			...
			<section className='bg-[#F8FBFF]'>
				<div className='max-w-[1243.406px] pb-[50px] lg:pb-[150px] space-y-[50px]  w-full relative lg:px-[126px] px-[40px]  mx-auto'>
					<div className='space-y-[30px] text-center lg:pt-0 pt-[100px] lg:text-start text-ce'>
						<p className='w-full max-w-[1037px] justify-center'>
							<span class='text-[#004aad] text-[40px] lg:text-[63px] font-normal MadeGentle leading-[42px] lg:leading-[58.72px]'>
								{renderPreTitle(pinkyPromiseSection.pinkyPromiseTitle)} <br />
							</span>
						</p>
						<p class='text-[#004aad] text-[28px] lg:text-[47px] font-normal font-["Montserrat"] leading-[28px] lg:leading-[36.08px]'>
							{renderPreTitle(pinkyPromiseSection.pinkyPromiseSubtitle)} <br />
						</p>
					</div>
				</div>
				<img
			...
			<section className='bg-[#EBF2FB] '>
				<div className='max-w-[1243.406px] pt-[100px]  space-y-[50px]  w-full relative lg:px-[126px] px-[40px] pb-[50px]  mx-auto'>
					<p className='w-full max-w-[1037px] justify-center'>
						<span class='text-[#004AAD] text-[40px] lg:text-[63px] font-normal MadeGentle leading-[42px] lg:leading-[58.72px]'>
							{renderPreTitle(storyMissionSection.headline)}
						</span>
					</p>
					<p className="w-full max-w-[953px]  justify-start text-[#004aad] text-base lg:text-lg font-medium font-['Montserrat'] leading-7 lg:leading-9">
						{renderPreTitle(storyMissionSection.bodyText)}
					</p>
				</div>
				<div className='max-w-[1243.406px]  space-y-[50px]  w-full relative lg:px-[126px] px-[40px] pb-[50px]  mx-auto'>
					<p className='w-full max-w-[1037px] justify-center'>
						<span class='text-[#86D24A] text-[40px] lg:text-[63px] font-normal MadeGentle leading-[42px] lg:leading-[58.72px]'>
							{renderPreTitle(growthSection.headline)}
						</span>
					</p>
					<p className="w-full max-w-[953px]  justify-start text-[#004aad] text-base lg:text-lg font-medium font-['Montserrat'] leading-7 lg:leading-9">
						{renderPreTitle(growthSection.bodyText)}
					</p>
				</div>
				<div className='max-w-[1243.406px]   space-y-[50px]  w-full relative lg:px-[126px] px-[40px] pb-[50px]  mx-auto'>
					<p className='w-full max-w-[1037px] justify-center'>
						<span class='text-[#86D24A] text-[40px] lg:text-[63px] font-normal MadeGentle leading-[42px] lg:leading-[58.72px]'>
							{renderPreTitle(teamSection.headline)}
						</span>
					</p>
					<p className="w-full max-w-[953px]  justify-start text-[#004aad] text-base lg:text-lg font-medium font-['Montserrat'] leading-7 lg:leading-9">
						{renderPreTitle(teamSection.bodyText)}
					</p>
				</div>
			</section>
			<section className='bg-[#F8FBFF] pb-[50px] lg:pb-[100px]'>
				...
				<div className='max-w-[1243.406px]  space-y-[50px]  w-full relative lg:px-[126px] px-[40px] pb-[50px]  mx-auto'>
					<p className='w-full text-[#004aad] max-w-[1037px] justify-center'>
						<span class=' text-[40px] lg:text-[63px] font-normal MadeGentle leading-[42px] lg:leading-[58.72px]'>
							{renderPreTitle(recognitionSection.headline)}
						</span>
					</p>
					<p className="w-full max-w-[1017px] justify-start text-[#004aad] text-base lg:text-lg font-medium font-['Montserrat'] leading-7 lg:leading-9">
						{renderPreTitle(recognitionSection.bodyText)}
					</p>
				</div>
			</section>
			<div className='bg-[#F8FBFF]'>
